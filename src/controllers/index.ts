export { addPersonalMovie, getPersonalMovies, deletePersonalMovie } from './personalMovies.controller';
...
export { default as getMovieDetails } from './movieDetails.controller';
